import { BlockChainWorkShop1_backend } from "../../declarations/BlockChainWorkShop1_backend";
...
calculateButton.addEventListener("click", async () => {
  try {
    ...
    let data = await BlockChainWorkShop1_backend.ageCalculate(currentData, birthData);
